...
// Large Sifter
    ...
    .setChance(0.05)
    .outputItem(Item.of('secretly_complicated:potassium_nitrate_gem').withCount(1))
    .setChance(0.05)
    .outputItem(Item.of('secretly_complicated:apatite_gem').withCount(1))
    .setChance(0.05)
    .outputItem(Item.of('secretly_complicated:cinnabar_gem').withCount(1))
    .setChance(1.0)
    .setPerTick(true)
    .inputFE(30)
    .duration(80)
    ...
    .inputItem(Item.of('minecraft:gravel', 1))
    .setChance(0.0)
    .inputItem(Item.of('exnihilosequentia:iron_mesh', 1))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:silicon_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:manganese_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:chromium_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:silver_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:tin_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:nickel_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:zinc_impure_dust').withCount(2))
    .setChance(1.0)
    .setPerTick(true)
    .inputFE(60)
    .duration(80)
    //
    event.recipes.multiblocked.multiblock("large_sifter")
    .inputItem(Item.of('exnihilosequentia:crushed_netherrack', 1))
    .setChance(0.0)
    .inputItem(Item.of('exnihilosequentia:iron_mesh', 1))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:bitumen_gem').withCount(2))
    .setChance(0.05)
    .outputItem(Item.of('minecraft:netherite_scrap').withCount(1))
    .setChance(0.10)
    .outputItem(Item.of('secretly_complicated:sulfur_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:cobalt_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:lead_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:aluminium_impure_dust').withCount(2))
    .setChance(0.25)
    .outputItem(Item.of('secretly_complicated:titanium_impure_dust').withCount(2))
    .setChance(1.0)
    .setPerTick(true)
    .inputFE(60)
    .duration(80)
