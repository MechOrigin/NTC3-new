...
var tagGen = [
    ...
    "aluminium=blocks,ingots,nuggets,ores,raw_ores,dusts,gears,plates,rods",
    ...
    "coal=blocks,gems,dusts,clump,crystal,dirty_dust,shard,fragment,chunks",
    ...
    "diamond=blocks,ingots,nuggets,dusts,gears,plates,rods,clump,crystal,dirty_dust,shard,fragment,chunks",
    "emerald=blocks,ingots,nuggets,dusts,gears,plates,rods,clump,crystal,dirty_dust,shard,fragment,chunks",
    "lapis=blocks,ingots,nuggets,dusts,gears,plates,rods,clump,crystal,dirty_dust,shard,fragment,chunks",
    "redstone=blocks,chunks,crystal,dirty_dust,shard,fragment",
    "nether_quartz=blocks,dusts,gears,clump,crystal,dirty_dust,shard,fragment,chunks",
    ...
    "uranium=blocks,ingots,nuggets,dusts,rods,fragment,chunks",
    "osmium=blocks,ingots,nuggets,dusts,gears,plates,rods,fragment,chunks",
    ...
    "cobalt=blocks,ingots,nuggets,dusts,gears,plates,rods,clump,crystal,dirty_dust,shard,fragment,chunks",
    ...
    "bitumen=blocks,gems,clump,crystal,dirty_dust,shard,fragment,chunks",
    "cinnabar=blocks,gems,clump,dusts,crystal,dirty_dust,shard,fragment,chunks",
    "apatite=blocks,gems,clump,crystal,dirty_dust,shard,fragment,chunks",
    "sulfur=blocks,gems,clump,dusts,crystal,dirty_dust,shard,fragment,chunks",
    "potassium_nitrate=blocks,gems,clump,dusts,crystal,dirty_dust,shard,fragment,chunks",
    // "dimensional=storage_blocks,clump,dusts,crystal,dirty_dust,shard,fragment,chunks",
    "silicon=blocks,gems,dusts",
