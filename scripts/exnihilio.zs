...
.addDrop(<item:alcocraft:hop_seeds>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("lily_of_the_valley")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:white>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("tulip")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:orange>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("allium")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:magenta>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("blue_orchid")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:light_blue>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("dandelion")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:yellow>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("pink_tulip")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:pink>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("white_tulip")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:light_gray>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("corn_flower")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:blue>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("poppy")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:red>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("wither_rose")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:black>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("red_tulip")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:red_tulip>)
.addRoll("string", 0.35);

<recipetype:exnihilosequentia:sieve>
.create("azure_bluet")
.setInput(<item:minecraft:dirt>)
.addDrop(<item:finallyfarmabledyes:azure_bluet>)
.addRoll("string", 0.35);
