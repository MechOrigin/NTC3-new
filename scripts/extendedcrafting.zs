...
mods.extendedcrafting.TableCrafting.addShaped("a2f6c342-f57e-436b-9011-ff36005305f6", 1, <item:projecte:collector_mk1>, [
	[<item:minecraft:glowstone>, <item:minecraft:diamond_block>, <item:minecraft:glowstone>], 
...
mods.extendedcrafting.TableCrafting.addShaped("ea13449f-4757-4444-9290-4b037ee78bba", 1, <item:projecte:relay_mk1>, [
	[<tag:items:forge:obsidian>, <item:minecraft:diamond_block>, <tag:items:forge:obsidian>], 
...
mods.extendedcrafting.TableCrafting.addShaped("b1a8d56e-6097-40d6-a605-cd147e0b80fd", 1, <item:projecte:alchemical_chest>, [
	...
	[<tag:items:tconstruct:smeltery_bricks>, <item:minecraft:diamond_block>, <tag:items:tconstruct:smeltery_bricks>], 
...
mods.extendedcrafting.TableCrafting.addShaped("5102e0ef-1964-4ef2-b03f-93cca6354d14", 1, <item:projecte:condenser_mk1>, [
	[<item:secretly_complicated:black_steel_dense_plate>, <item:minecraft:diamond_block>, <item:secretly_complicated:black_steel_dense_plate>], 
	[<item:minecraft:diamond_block>, <item:projecte:alchemical_chest>, <item:minecraft:diamond_block>], 
	[<item:secretly_complicated:black_steel_dense_plate>, <item:minecraft:diamond_block>, <item:secretly_complicated:black_steel_dense_plate>]
]);
